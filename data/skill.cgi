...
@skills = (
	...
	[71,	'¸²¯¸¼®¯Ä',		'e',	10,	sub{ &_d( $_[0]*(rand(1)+0.5) ); },								'',	sub{ ${$who.'_is_stanch'} = 1; },	15],
	[72,	'¿²Ù¼®¯Ä',		'e',	12,	sub{ my $v=rand(30)+2;	&_mp_d( $v ); },						'',	sub{},										0],
	[73,	'ØÛ°ÄŞ',			'e',	20,	sub{ &_mp_heal( 0.2, 'mat' ); },									'',	sub{},										-5],
	[74,	'Ò¼±À²Ñ',		'e',	22,	sub{ my $v=int(rand(5));	&_d( $_[0]*0.6 ) for (0 .. $v); },											'',	sub{},										10],
	[75,	'±İ¶Ş°Ï¯¸½',	'e',	32,	sub{ $is_direct=1;		&_d( $_[0]*0.5 ); },					'',	sub{},										20],
	[76,	'Ê¯Ëß°ÄØ¶Ş°',	'e',	40,	sub{ &_heal( 0.15, 'mdf' ); },									'',	sub{},										-5],
	[77,	'ÄŞ×ºŞ¸×¯¼­',	'e',	54,	sub{ $is_direct=1;		&_d( rand(0.7)+0.3, 'lea' );},	'',	sub{},										30],
	[78,	'¶Şİ¶À',			'e',	90,	sub{ $is_guard_s=1;		&_d( rand($_[0]*0.3) ); },			'',	sub{ ${$who.'_is_guard'} = 1; },		5],
	[79,	'½×ÑÌ§²±',		'e',	99,	sub{ $risk=$_[0]*0.35;	&_d( rand(3)*2*$_[0] ); },			'',	sub{},										30],
	[80,	'¶À½ÄÛÌ¨',		'e',	99,	sub{ $is_direct=1;		&_d( $_[0]*(rand(0.8)+0.4) ); },	'',	sub{},										30],
);
=pod
Ò¼±À²Ñ@1`5‰ñUŒ‚@¬ƒ_ƒ[ƒW@Á”ïMP22@(UŒ‚—Í*0.7)*0.5-“G–hŒä*0.3
ØÛ°ÄŞ@MP‰ñ•œ@–‚—Í‚ÉˆË‘¶@Á”ïMP20@‚l‚o‰ñ•œ=(0.2)*MAG
ÄŞ×ºŞ¸×¯¼­@ŠÑ’Ê@“—¦‚ÉˆË‘¶@‘åƒ_ƒ[ƒW@Á”ïMP54@((0`1)+0.3)*LEA
Ê¯Ëß°ÄØ¶Ş°@HP‰ñ•œ@–‚–h‚ÉˆË‘¶@Á”ïMP40@‚g‚o‰ñ•œ=(0`0.5)*0.3*MDF
¶Şİ¶À@ƒJƒEƒ“ƒ^[@¬ƒ_ƒ[ƒW@Á”ïMP90@((0`UŒ‚—Í)*0.3)*0.5-“G–hŒä*0.3
¸²¯¸¼®¯Ä@¬ƒ_ƒ[ƒW@ƒXƒ^ƒ“@Á”ïMP10@(UŒ‚—Í*((0`1)+0.4))*0.5-“G–hŒä*0.3
±İ¶Ş°Ï¯¸½@ŠÑ’Ê@’†ƒ_ƒ[ƒW@Á”ïMP32@UŒ‚—Í*0.5
¿²Ù¼®¯Ä@MP’†ƒ_ƒ[ƒW@Á”ïMP12@‚l‚oUŒ‚=(0`30)+2
½×ÑÌ§²±@ŠÑ’Ê@‘åƒŠƒXƒN@‘åƒ_ƒ[ƒW@Á”ïMP99@((0`3)*2*UŒ‚—Í)*0.5@ƒŠƒXƒN=UŒ‚—Í*0.35
¶À½ÄÛÌ¨@ŠÑ’Ê@’†`‘åƒ_ƒ[ƒW@Á”ïMP99@UŒ‚—Í*((0`0.8)+0.4) 
=cut
