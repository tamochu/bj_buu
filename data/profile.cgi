...
sub header_profile {
	...
	print qq|<a href="sacrifice.cgi?id=$in{id}&country=$in{country}&title=Sacrifice">生贄</a>/| if -f "$userdir/$in{id}/use_pet_log.cgi";
	print qq|<a href="breeder.cgi?id=$in{id}&country=$in{country}&title=Breeder">ﾌﾞﾘｰﾀﾞｰ</a>/| if -f "$userdir/$in{id}/pet_icon.cgi";
	print qq|<hr><br>|;
}
