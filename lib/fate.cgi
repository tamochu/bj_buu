...
#	[0]No	[1]–¼‘O			[2]type			[3]”{—¦	[4]‘I‘ğ‰Â”\	[5]”­“®—¦(%)
	...
	[2,		'ŒR–¬Œ÷',		'military',		0.4,	1,			15],
	[3,		'‹UŒvŒˆ—ô',		'breakdown',	1,		0,			100],
	[4,		'ŠOŒğ¬Œ÷',		'promise',		0.4,	1,			12],
	[5,		'éí•z',		'declaration',	0.8,	0,			30], # ’âí‚Æˆá‚Á‚Ä”\“®“I‚É•z‚Å‚«‚é‚©‚ç’á‚ß ‚à‚Á‚Æ’á‚­‚Ä‚à—Ç‚³‚»‚¤‚¾‚¯‚Ç“K“–‚Å“–‚½‚é‚©‚ç
	[6,		'’âíğ–ñ',		'cessation',	0.6,	0,			60], # •z‚Æˆá‚Á‚Äó“®“I‚¾‚©‚ç•z‚æ‚è‚‚ß
...
#	[0]No	[1]–¼‘O							[2]ğŒ		[3]”{—¦		[4]‘I‘ğ‰Â”\
	...
	[1,		'‚Ú‚Á‚¿‚Ì',						sub{ return !$union; },	0.12,	1], # ‚Ú‚Á‚¿‘‚Í‰„X‘S‘–¯‚ª‰¶Œbó‚¯‚é–ó‚¾‚©‚ç”{—¦‚‚­‚·‚é‚Æ‚½‚Ô‚ñ‹t‚Éˆê•û“I—L—˜‚É‚È‚è‚·‚¬‚é
	[2,		'‘—Íƒgƒbƒv',					sub{ for my $i (1..$w{country}) { if ($cs{strong}[$i] > $cs{strong}[$m{country}]) { return 0; } } return 1; },	0.7,	0],
	[3,		'‘Œ¹‚ª‚·‚×‚Ä100000–¢–‚Ì',	sub{ return ($cs{food}[$m{country}] < 100000 && $cs{money}[$m{country}] < 100000 && $cs{soldier}[$m{country}] < 100000); },	0.4,	1],
...
sub super_attack {
	...
	&use_count_up;
	&mes_and_world_news("•KE‹Z‚ğŠJ•ú‚µA$e_mesB<br><b>$m{name}u$voicev</b>", 1);
}
#=================================================
# C³ŒãŠ‘®l”
#=================================================
