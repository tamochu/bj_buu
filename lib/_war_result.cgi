...
#	&write_yran('war', 1, 1);
	...
	if ($w{world} eq $#world_states) {
		...
		# ±Î±Ø±©‘Ì‚ÍˆÃ•‚Ì“¯–¿‘‚ªˆÃ•‚ğ–Å‚Ú‚·‚Æ“¯–¿‘‚ğŒo—R‚µ‚ÄˆÃ•‚É“ˆêƒtƒ‰ƒO‚ª—§‚¿ˆÃ•Ÿ—˜‚É‚È‚éŒ»Û
		my $ahoalia = 1;
		for my $ac (@acs) {
		...
		if ($cs{strong}[$m{country}] >= $touitu_strong
			|| ($cs{strong}[$w{country}] <= 0
				&& $union ne $w{country}) # ‚±‚Á‚¿‚ª±Î±Ø±‘Îô
			|| ($ahoalia && $m{country} eq $w{country})) { # ‚±‚Á‚¿‚Í••ˆó‘¤‚ª‚·‚×‚Ä–Å–S‚µ‚Ä‚¢‚é‚©
			&_touitu;
		}
...
=pod
		...
		ˆÃ•‚Ì‘—Í‚ª 30000 ˆÈã‚Ì‚Í 1/4 ‚Å¶³İÀ°”­¶
		ˆÃ•‚Ì‘—Í‚ª 30000 –¢–‚È‚ç 1/3 ‚©‚Æv‚Á‚Ä‚½‚¯‚Ç‚æ‚­l‚¦‚½‚ç‰ÁZ‚È‚Ì‚Å (1/4) + (1/3) - (1/4*1/3) = 0.5 ‚Å–³‰ü‘¢‚ÌÅ‚¶³İÀ°—¦‚Í 50%
		¦Šm—¦‚Ì‰Á–@’è— A‚ª¶‚¶‚éŠm—¦ + B‚ª¶‚¶‚éŠm—¦ - (A‚ÆB‚ª¶‚¶‚éŠm—¦)
=cut
		else {
			# “ˆêŠúŒÀ‚âˆÃ•‚Ì‘—Í‚ğI”Õ”»’è‚Ì—v‘f‚Æ‚µ‚Ä¶³İÀ°—¦‚¤‚’²ß
			# ‘”‚Ì‘Œ¸‚Í–{—ˆˆÃ•‚Ì‹­ã‚Æ‚ÍŠÖŒW‚È‚¢‚Æv‚í‚ê‚é
			# ˆÃ•‚ªA3‘‚É‰£‚ç‚ê‚æ‚¤‚ª5‘‚É‰£‚ç‚ê‚æ‚¤‚ª10‘‚É‰£‚ç‚ê‚æ‚¤‚ª••ˆó‘¤‚Ì‘”‚ÉŠÖŒW‚È‚­‘í‘ˆ”‚Í“¯ˆê
			# •z‚µ‚Ä‚­‚é‘”‚ª‘‚¦‚é‚Ù‚ÇˆÃ••s—˜‚É‚È‚é‚Æ‚Ív‚¤‚ªA’D‘¶³İÀ°‚Ì’D‘—Í‚ğã‚°‚ê‚Î•z‚³‚ê‚Ä‚¢‚æ‚¤‚ªˆÃ•—L—˜‚É‚·‚é‚±‚Æ‚Í‰Â”\
			# –³‰ü‘¢‚Í‚»‚à‚»‚à•z‚³‚ê‚Ä‚é‘O’ñ‚Ì’D‘—Í‚Å”½Œ‚‚·‚é‚Ì‚Å•z‚µ‚Ä‚­‚é‘”‘‚¦‚Ä‚àˆÃ•‚Ì‹­ã‚É‚ÍŠÖŒW‚È‚¢‚Í‚¸
			# •“ØI‚Í•z‚Å••ˆó‘¤‚Ì’D‘—Í‚ªˆê•û“I‚Éã‚ª‚é‚æ‚¤‚É‚È‚Á‚Ä‚é‚Ì‚Å•z‚µ‚Ä‚­‚é‘‚ª‘‚¦‚é‚Ù‚ÇˆÃ•‚ª•s—˜‚É‚È‚é¨‘”‚É‚æ‚Á‚ÄˆÃ•‚Ì‹­ã‚ª•Ï‚í‚Á‚Ä‚µ‚Ü‚¤‚Ì‚ª•“ØI‚Ìd—l
			# Œ‹˜_A‘”‚É‚æ‚éˆÃ•‚Ì‹­ã‚Ì•Ï‰»‚Í••ˆó‘¤‚Ì’D‘—Í‚ÆˆÃ•‚Ì’D‘—Í‚Ì·‚ªo‚Ä‚µ‚Ü‚¤‚±‚Æ‚É‚æ‚é‚Ì‚ÅAˆÃ•‚Ì‹­ã‚Ìƒoƒ‰ƒ“ƒX’²®‚·‚é‚È‚çƒJƒEƒ“ƒ^[—¦‚æ‚è‚à’D‘—Í‚ğ’²®‚µ‚½•û‚ª—Ç‚¢
			# ‚±‚±‚Å‚Ì¶³İÀ°’²®‚ÍS‘©‚ª’·‚¢•Ilˆõ‚ª­‚È‚¢I‚¾‚ÆˆÃ•‚ªŠˆ”­‚É‚È‚é‘O‚É“ˆêŠúŒÀ‚ªØ‚ê‚»‚¤‚É‚È‚é‚Ì‘Îô
			# Ilˆõ‚ª‘‚¦‚½‚ç‚½‚Ô‚ñ—v‚ç‚È‚¢’²®
			my $npc_par = $cs{strong}[$w{country}] < 30000 ? 1 # ‘—Í30000–¢– = 2/4 = 50%
			    : $time + 2 * 24 * 3600 > $w{limit_time} ? 0.2 # ‘—Í30000ˆÈã + “ˆêŠúŒÀc‚è1“ú = 1.2/4 = 30%
			    : $time + 3 * 24 * 3600 > $w{limit_time} ? 0.15 # ‘—Í30000ˆÈã + “ˆêŠúŒÀc‚è2“ú = 1.15/4 = 28.7%
			    : $time + 4 * 24 * 3600 > $w{limit_time} ? 0.1 # ‘—Í30000ˆÈã + “ˆêŠúŒÀc‚è3“ú = 1.1/4 = 27.5%
			    : $time + 5 * 24 * 3600 > $w{limit_time} ? 0.05 # ‘—Í30000ˆÈã + “ˆêŠúŒÀc‚è4“ú = 1.05/4 = 26.2%
			    :                                          0 # ‘—Í30000ˆÈã + “ˆêŠúŒÀ5“úˆÈã = 1/4 = 25%
			    ;

			require './lib/vs_npc.cgi';
#			if( rand(4) < $npc_war  || ($cs{strong}[$w{country}] < 30000 && rand(3) < $npc_war) ) {
			if( rand(4) < (1 + $npc_par) ) { # Šm—¦‚Ì‰Á–@’è—g‚Á‚Ä¶³İÀ°—¦ŒvZ‚·‚é‚Ì–Ê“|‚È‚Ì‚ÅlŠÔ‚ª•ª‚©‚è‚â‚·‚¢‚æ‚¤‚ÉÈ—ª
			    &npc_war;
			}
		}
	}
	...
	if ($w{world} eq $#world_states) {
		if ($m{country} eq $w{country} || $union eq $w{country}) { # NPC‘‘¤‚ÌŸ—˜
			...
			for my $wc (@win_countries) {
				...
				open my $cfh, "< $logdir/$wc/member.cgi" or &error("$logdir/$wc/member.cgiÌ§²Ù‚ªŠJ‚¯‚Ü‚¹‚ñ");
				while (my $player = <$cfh>) {
					$player =~ tr/\x0D\x0A//d;
					next if ++$sames{$player} > 1; # ª‚Ì‘ã•\•ñV‚Å‚·‚Å‚É–¼‘Oo‚Ä‚é‚Ì‚ÅÄ“x•ñVo‚é‚±‚Æ‚Í‚È‚¢
