...
Game.onLoad = function () {
    ...
    this.core.preload(
          './html/cataso_view/background.png'
        , './html/cataso_view/button.png'
        , './html/cataso_view/map.png'
        , './html/cataso_view/land.png'
        , './html/cataso_view/number.png'
        , './html/cataso_view/robber.png'
        , './html/cataso_view/active.png'
        , './html/cataso_view/priority.png'
        , './html/cataso_view/settlement.png'
        , './html/cataso_view/road.png'
        , './html/cataso_view/resource.png'
        , './html/cataso_view/skin.png'
        , './html/cataso_view/resource-button.png'
        , './html/cataso_view/updown.png'
        , './html/cataso_view/card.png'
        , './html/cataso_view/prize.png'
        , './html/cataso_view/dice.png'
        , './html/cataso_view/signpost.png'
    );
...
Game.onMessage = function (game) {
    ...
    this.canSend = true;
    this.removeAll();
    this.addSprite('./html/cataso_view/background.png', 0, 0, 0, 800, 545);
...
Game.addSetupOption = function(game) {
    ...
    this.addSprite('./html/cataso_view/signpost.png', frame, 2, 2, 30, 30);
}
        ...
        switch (game.phase) {
            ...
            case Phase.BUILD_ROAD:
                if (this.hasPriorityUid(game, uid)) {
                    ...
                    this.addSprite('./html/cataso_view/button.png', 13, 610, 435, 80, 25, function () {
                        Game.send('e');
                    });
                }
                break;
...
Game.addReadyCommand = function (game) {
    ...
    if (canJoin) {
        this.addSprite('./html/cataso_view/button.png', 0, 610, 422, 80, 25, function () {
            Game.send('b');
        });
    }

    if (canLeave) {
        this.addSprite('./html/cataso_view/button.png', 1, 700, 422, 80, 25, function () {
            Game.send('c');
        });

        if (canStart) {
            this.addSprite('./html/cataso_view/button.png', 2, 520, 422, 80, 25, function () {
                Game.send('d');
            });
        }
    }
...
Game.addBurstCommand = function (game) {
    this.addSprite('./html/cataso_view/skin.png', 0, 499, 338, 299, 205);
    ...
    for (i = 0; i < len1; i++) {
        if (game.playerList[i].burst > 0) {
            if (game.playerList[i].uid === uid) {
                ...
                var j;
                for (j = 0; j < 5; j++) {
                    this.addSprite('./html/cataso_view/resource-button.png', j + 5, j * 40 + 598, i * 51 + 347, 30, 30, function () {
...
Game.addDomesticTrade1Command = function (game) {
    this.addSprite('./html/cataso_view/skin.png', 2, 499, 338, 299, 205);
    ...
    for (i = 0; i < 5; i++) {
        ...
        this.addSprite('./html/cataso_view/updown.png', 0, i * 53 + 563, 398, 15, 15, function () {
            var _i = i;
            var _label = label;
        ...
        this.addSprite('./html/cataso_view/updown.png', 1, i * 53 + 563, 412, 15, 15, function () {
            var _i = i;
            var _label = label;
        ...
        this.addSprite('./html/cataso_view/updown.png', 0, i * 53 + 563, 429, 15, 15, function () {
            var _i = i;
            var _label = label;
        ...
        this.addSprite('./html/cataso_view/updown.png', 1, i * 53 + 563, 443, 15, 15, function () {
            var _i = i;
            var _label = label;
    ...
    this.addSprite('./html/cataso_view/button.png', 14, 520, 470, 80, 25, function () {
        if (game.active !== 0) {
            return function () {
    ...
    this.addSprite('./html/cataso_view/button.png', 15, 610, 470, 80, 25, function () {
        if (game.active !== 1) {
            return function () {
    ...
    this.addSprite('./html/cataso_view/button.png', 16, 700, 470, 80, 25, function () {
        if (game.active !== 2) {
            return function () {
    ...
    if (game.playerSize === 4) {
        this.addSprite('./html/cataso_view/button.png', 17, 520, 500, 80, 25, function () {
            if (game.active !== 3) {
                return function () {
    ...
    this.addSprite('./html/cataso_view/button.png', 13, 610, 500, 80, 25, function () {
        Game.send('e');
    });
}
...
Game.addDomesticTrade2Command = function (game) {
    ...
    this.addSprite('./html/cataso_view/button.png', 12, 570, 480, 80, 25, function () {
        Game.send('w');
    });
    
    this.addSprite('./html/cataso_view/button.png', 13, 660, 480, 80, 25, function () {
        Game.send('x');
    });
}
...
Game.addInternationalTrade = function (game) {
    ...
    this.addSprite('./html/cataso_view/button.png', 12, 570, 490, 80, 25, function () {
        var i;
    ...
    this.addSprite('./html/cataso_view/button.png', 13, 660, 490, 80, 25, function () {
        Game.send('e');
    });
}

Game.addCardCommand = function (game) {
    this.addSprite('./html/cataso_view/button.png', 18, 520, 470, 80, 25, function () {
    ...
    this.addSprite('./html/cataso_view/button.png', 19, 610, 470, 80, 25, function () {
    ...
    this.addSprite('./html/cataso_view/button.png', 20, 700, 470, 80, 25, function () {
    ...
    this.addSprite('./html/cataso_view/button.png', 21, 520, 500, 80, 25, function () {
...
Game.addDiceCommand = function (game) {
    this.addSprite('./html/cataso_view/skin.png', 1, 499, 338, 299, 205);
    
    this.addSprite('./html/cataso_view/button.png', 3, 570, 384, 80, 25, function () {
        Game.send('j');
    });
    
    this.addSprite('./html/cataso_view/button.png', 10, 660, 384, 80, 25, function () {
...
Game.addYearOfPlentyCommand = function (game) {
    ...
    var i;
    for (i = 0; i < 5; i++) {
        this.addSprite('./html/cataso_view/resource-button.png', i + 10, i * 40 + 560, 425, 30, 30, function () {
            var _i = i;
...
Game.addMonopolyCommand = function (game) {
    ...
    var i;
    for (i = 0; i < 5; i++) {
        this.addSprite('./html/cataso_view/resource-button.png', i, i * 40 + 560, 425, 30, 30, function () {
            var _i = i;
...
Game.addMainCommand = function (game) {
    ...
    this.addSprite('./html/cataso_view/button.png', 4, 520, 354, 80, 25, function () {
        if (
    ...
    this.addSprite('./html/cataso_view/button.png', 5, 610, 354, 80, 25, function () {
        if (
    ...
    this.addSprite('./html/cataso_view/button.png', 6, 700, 354, 80, 25, function () {
        if (
    ...
    this.addSprite('./html/cataso_view/button.png', 7, 520, 384, 80, 25, function () {
        if (
    ...
    this.addSprite('./html/cataso_view/button.png', 8, 610, 384, 80, 25, function () {
        Game.send('u');
    });
    
    this.addSprite('./html/cataso_view/button.png', 9, 700, 384, 80, 25, function () {
        Game.send('y');
    });
    
    this.addSprite('./html/cataso_view/button.png', 10, 520, 414, 80, 25, function () {
        if (game.playerList[game.active].baseScore + game.playerList[game.active].bonusScore >= 10) {
            return function () {
                Game.send('A');
            };
    ...
    this.addSprite('./html/cataso_view/button.png', 11, 610, 414, 80, 25, function () {
        Game.send('B');
    });
...
Game.addDice = function (game) {
    if (game.dice1 !== Index.NONE) {
        this.addSprite('./html/cataso_view/dice.png', game.dice1 - 1, 25, 100, 30, 30);
        this.addSprite('./html/cataso_view/dice.png', game.dice2 - 1, 56, 100, 30, 30);
    }
}
...
Game.addPlayer = function (game, color) {
    if (game.state === State.PLAYING) {
        if (game.active === color) { this.addSprite('./html/cataso_view/active.png', 0, 503, color * 78 + 29, 15, 15); }
        if (Game.hasPriorityColor(game, color)) {
            this.addSprite('./html/cataso_view/priority.png', 0, 523, color * 78 + 26, 112, 21);
        }
    }
    ...
    if (summary1 > 18) {
        if (game.state === State.READY || game.playerList[color].uid === uid) {
            for (i = 0; i < 5; i++) {
                if (game.playerList[color].resource[i] > 0) {
                    this.addSprite('./html/cataso_view/resource.png', i, k * 38 + 500, color * 78 + 52, 15, 15);
            ...
            this.addSprite('./html/cataso_view/resource.png', 5, 500, color * 78 + 52, 15, 15);
        ...
        for (i = 0; i < 5; i++) {
            ...
            for (j = 0; j < len1; j++) {
                if (game.state === State.READY || game.playerList[color].uid === uid) {
                    this.addSprite('./html/cataso_view/resource.png', i, k * 16 + 500, color * 78 + 52, 15, 15);
                } else {
                    this.addSprite('./html/cataso_view/resource.png', 5, k * 16 + 500, color * 78 + 52, 15, 15);
                }
    ...
    if(summary1 > 15) {
        ...
        if (game.state === State.READY || game.playerList[color].uid === uid) {
            for (i = 0; i < 5; i++) {
                ...
                if (summary2 > 0) {
                    this.addSprite('./html/cataso_view/card.png', i, k * 24 + 500, color * 78 + 69, 30, 30);
            ...
            for (i = 0; i < 5; i++) {
                if (game.playerList[color].deadCard[i] > 0) {
                    this.addSprite('./html/cataso_view/card.png', i, k * 24 + 518, color * 78 + 69, 30, 30);
            ...
            this.addSprite('./html/cataso_view/card.png', 5, 500, color * 78 + 69, 30, 30);
            ...
            for (i = 0; i < 5; i++) {
                if (game.playerList[color].deadCard[i] > 0) {
                    this.addSprite('./html/cataso_view/card.png', i, k * 31 + 586, color * 78 + 69, 30, 30);
        ...
        for (i = 0; i < 5; i++) {
            ...
            for (j = 0; j < len1; j++) {
                if (game.state === State.READY || game.playerList[color].uid === uid) {
                    this.addSprite('./html/cataso_view/card.png', i, k * 15 + 500, color * 78 + 69, 30, 30);
                } else {
                    this.addSprite('./html/cataso_view/card.png', 5, k * 15 + 500, color * 78 + 69, 30, 30);
                }
        ...
        for (i = 0; i < 5; i++) {
            ...
            for (j = 0; j < len1; j++) {
                this.addSprite('./html/cataso_view/card.png', i, k * 15 + 525, color * 78 + 69, 30, 30);
    ...
    if (color === game.longestRoad) {
        this.addSprite('./html/cataso_view/prize.png', 1, 777, color * 78 + 79, 20, 20);
    }

    if (color === game.largestArmy) {
        this.addSprite('./html/cataso_view/prize.png', 0, 767, color * 78 + 69, 20, 20);
    }
}

Game.addMap = function (game) {
    if(game.landList.length > 0) {
        this.addSprite('./html/cataso_view/map.png', 0, 8, 85, 484, 434);
        ...
        for (i = 0; i < len1; i++) {
            ...
            if (i < 3) {
                this.addSprite('./html/cataso_view/land.png', frame, i * 69 + 145, 144, 70, 80);
            } else if (i < 7) {
                this.addSprite('./html/cataso_view/land.png', frame, (i - 3) * 69 + 111, 203, 70, 80);
            } else if (i < 12) {
                this.addSprite('./html/cataso_view/land.png', frame, (i - 7) * 69 + 77, 262, 70, 80);
            } else if (i < 16) {
                this.addSprite('./html/cataso_view/land.png', frame, (i - 12) * 69 + 112, 321, 70, 80);
            } else {
                this.addSprite('./html/cataso_view/land.png', frame, (i - 16) * 69 + 147, 380, 70, 80);
            }
        }
        ...
        for (i = 0; i < len1; i++) {
            if (game.numberList[i] !== Land.DESERT) {
                ...
                if (i < 3) {
                    this.addSprite('./html/cataso_view/number.png', frame, i * 69 + 165, 169, 30, 30);
                } else if (i < 7) {
                    this.addSprite('./html/cataso_view/number.png', frame, (i - 3) * 69 + 131, 228, 30, 30);
                } else if (i < 12) {
                    this.addSprite('./html/cataso_view/number.png', frame, (i - 7) * 69 + 97, 287, 30, 30);
                } else if (i < 16) {
                    this.addSprite('./html/cataso_view/number.png', frame, (i - 12) * 69 + 132, 346, 30, 30);
                } else {
                    this.addSprite('./html/cataso_view/number.png', frame, (i - 16) * 69 + 167, 405, 30, 30);
                }
            }
        }
        
        if (game.robber < 3) {
            this.addSprite('./html/cataso_view/robber.png', 0, game.robber * 69 + 155, 159, 50, 50, null, 0.7);
        } else if (game.robber < 7) {
            this.addSprite('./html/cataso_view/robber.png', 0, (game.robber - 3) * 69 + 121, 218, 50, 50, null, 0.7);
        } else if (game.robber < 12) {
            this.addSprite('./html/cataso_view/robber.png', 0, (game.robber - 7) * 69 + 87, 277, 50, 50, null, 0.7);
        } else if (game.robber < 16) {
            this.addSprite('./html/cataso_view/robber.png', 0, (game.robber - 12) * 69 + 122, 336, 50, 50, null, 0.7);
        } else {
            this.addSprite('./html/cataso_view/robber.png', 0, (game.robber - 16) * 69 + 157, 395, 50, 50, null, 0.7);
        }
    }
}
...
Game.addSettlement = function (game) {
    ...
    for (i = 0; i < len1; i++) {
        ...
        if (rank >= 0) {
            ...
            this.addSprite('./html/cataso_view/settlement.png', (game.settlementList[i] & 0x00ff) * 2 + rank, x, y, 30, 30);
        }
    }
}
...
Game.addRoad = function (game) {
    ...
    for (i = 0; i < len1; i++) {
        if(game.roadList[i] !== Index.NONE) {
            ...
            this.addSprite('./html/cataso_view/road.png', game.roadList[i] * 3 + angle, x, y, 30, 30);
        }
    }
}
            ...
            switch(game.phase) {
                case Phase.SETUP_SETTLEMENT1:
                    if (this.canBuildSetupSettlement(game, i)) {
                        this.addSprite('./html/cataso_view/settlement.png', 8, x, y, 30, 30, function () {
                            var _i = i;
    ...
    if (
        ...
        for (i = 0; i < len1; i++) {
            if (i !== game.robber) {
                ...
                this.addSprite('./html/cataso_view/robber.png', 1, x, y, 50, 50, function () {
                    var _i = i;
